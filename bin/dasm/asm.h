...
INCFILE {
    ...
    long   saveidx;	/*  save localindex	    */
#if OlafDol
    long   savedolidx; /*  save localdollarindex   */
#endif
};
...
REPLOOP {
    ...
    long   lineno; /*	  line number of line before  */
...
SEGMENT {
    ...
    long   org;    /*	  current org			*/
    long   rorg;   /*	  current rorg			*/
    long   initorg;
    long   initrorg;
    ubyte   initflags;
    ubyte   initrflags;
...
extern long	Redo, Redo_why, Redo_eval;
#if OlafPhase
extern long	Redo_if;
#endif
extern long	Localindex, Lastlocalindex;
#if OlafDol
extern long	Localdollarindex, Lastlocaldollarindex;
#endif
...
extern long	Plab, Pflags;
extern char	Inclevel;
extern char	ListMode;
extern long	Processor;
