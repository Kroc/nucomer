...
Elitist arguments about "original hardware" must be pushed back. Those with a nostalgic connection to the C64 must give willingly their knowledge to a future world in which there is no original hardware, only defacto standards, otherwise it will be they who'll be forgotten.
...
The Zilog Z80 CPU -- an independently enhanced Intel 8080, and therefore a "cousin" to x86 -- featured in the ZX Spectrum (Timex Sinclair in the USA), Amstrad CPC, Tandy / RadioShack TRS 80, inumerable CP/M business systems, the MSX standard popular in Japan and later in consoles such as the SEGA Master System and, in a stripped down form, as the Nintendo Game Boy.
