...
This publication exists to emplore, educate and demonstrate the satisfaction that comes from 8-bit systems and software, particularly the Commodore 64 (because of its large and active userbase online). It is my sincere hope that you, the reader, have had to expend the least amount of effort in getting to this point. Maybe you're reading this in an emulator, in a web browser, and that is fine with me.
